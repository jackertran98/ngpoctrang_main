...
class DetailProducts extends Component {
  ...
  shareContent=(text)=>{
    Share1.shareSingle({
      ...
      subject:'123',
      quote:'12334',
      url:'https://f5sell.com/upload//banbuonthuocmoma@gmail.com/thuoc_tan_duoc/tim_mach/procoralan_5mg_(hop_4_vi_x_14_vien)/procoradan5mg.jpg',
      social: Share1.Social.FACEBOOK,
    }).catch((err) => console.log("loi facebook",err));
  }
  handleTouchBuy = () => {
